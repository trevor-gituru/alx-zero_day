...
```bash
razaoul@trevor-HP-650-Notebook-PC:~/Documents/software_dev/alx/alx-zero_day/0x03-git$ git checkout master
Switched to branch 'master'
Your branch is up to date with 'origin/master'.
razaoul@trevor-HP-650-Notebook-PC:~/Documents/software_dev/alx/alx-zero_day/0x03-git$ git merge update_script 
Auto-merging 0x03-git/bash/alx
CONFLICT (content): Merge conflict in 0x03-git/bash/alx
Automatic merge failed; fix conflicts and then commit the result.
razaoul@trevor-HP-650-Notebook-PC:~/Documents/software_dev/alx/alx-zero_day/0x03-git$ git checkout --theirs 0x03-git/bash/alx
error: pathspec '0x03-git/bash/alx' did not match any file(s) known to git
razaoul@trevor-HP-650-Notebook-PC:~/Documents/software_dev/alx/alx-zero_day/0x03-git$ git checkout --theirs /0x03-git/bash/alx
fatal: Invalid path '/0x03-git': No such file or directory
razaoul@trevor-HP-650-Notebook-PC:~/Documents/software_dev/alx/alx-zero_day/0x03-git$ git checkout --theirs ./bash/alx
Updated 1 path from the index
razaoul@trevor-HP-650-Notebook-PC:~/Documents/software_dev/alx/alx-zero_day/0x03-git$ git add bash/alx 
razaoul@trevor-HP-650-Notebook-PC:~/Documents/software_dev/alx/alx-zero_day/0x03-git$ git commit -m "Chose to merge update_script branch and keep its verion of ./bash/alx"
[master f098a92] Chose to merge update_script branch and keep its verion of ./bash/alx
```
...
```bash
razaoul@trevor-HP-650-Notebook-PC:~/Documents/software_dev/alx/alx-zero_day/0x03-git$ echo '*~' > .gitignore
```
